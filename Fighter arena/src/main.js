...
function bootstrap() {
  ...
  function refreshSessionChrome() {
    ...
    const mobileControlsActive = padVisible && !screenFitEditorOpen && !controlFitEditorOpen && !socialPanelOpen && !shopPanelOpen && !settingsPanelOpen && !storyBrowserOpen;
    ...
    phoneEmuRotateButton.classList.toggle("is-hidden", !phoneEmulationEnabled);
  ...
  function openSocialPanel() {
    ...
    window.setTimeout(function () {
      if (selectedControlScheme === CONTROL_SCHEMES.pad) {
        socialChatInput.focus({ preventScroll: true });
      } else {
